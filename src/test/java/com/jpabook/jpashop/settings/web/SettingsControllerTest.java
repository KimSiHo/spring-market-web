...
class SettingsControllerTest {
    ...
    */
    ...
    void updateProfile() throws Exception {
        ...
        Account siho = accountRepository.findByNickname("siho");
        assertEquals(bio, siho.getBio());
    }
    ...
    void updatePassword_success() throws Exception {
        ...
        Account siho = accountRepository.findByNickname("siho");
        assertTrue(passwordEncoder.matches("123456789", siho.getPassword()));
    }
